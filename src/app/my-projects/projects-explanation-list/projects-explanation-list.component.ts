...
export class ProjectsExplanationListComponent {
  ...
  projectExp: ProjectExplanation[] = [      new ProjectExplanation('The Maze',`The game's objective is to collect four coins while avoiding 
  ...
  Design Patterns: Strategy, Factory, Multimethod, Observer, Command and Singleton.`),
    ...
    new ProjectExplanation('Memory Game',`Memory Game is a classic card matching game built with HTML5, CSS, and JavaScript. 
  The objective of the game is to find all the matching pairs of cards in the least number of moves and as quickly as possible. It's a fun and challenging game that tests your memory and concentration skills.`)
                                  ...
                                  The back-end will use Spring to create a REST API for cart handling and purchase recording. Spring session beans will store
                                   ...
                                   ,new ProjectExplanation('My Cookbook',`My Cookbook is a responsive digital recipe book that allows you to manage your collection of recipes.
                                                                                                                                 Built with Angular for the front end, Node.js for server-side logic, and MySQL for the database, this application provides a 
                                                                                                                                 seamless and efficient recipe management experience.
                                                                                                                               Create an account, log in securely with JSON Web Tokens (JWT), and start entering your recipes with details such as recipe name, preparation time, description, servings, vegetarian,
                                                                                                                                gluten_free, ingredients, and url_photo. Manage your recipes by deleting any unwanted entries from your collection.`)
                                   ...
                                   Denying access to URLs based on a list of blocked sites that can be added/removed dynamically Denying access to resources of type image Denying access to resources of type HTML5 Denying access to resources containing cookies
                                    ...
                                    ,new ProjectExplanation('Targeted Lotto Counter',`The father creates a child, and the child executes the next operation N times:
                                     ...
                                     Design Pattarens: Singleton, Command, and Multimethods.`)
                                              ...
                                              `This program demonstrates a simple producer-consumer scenario using named pipes. The producer generates random prime numbers and sends them through a named pipe.
                                               ...
                                               ),new ProjectExplanation('Cheaper App',`In progress...`)
